...
symbol_by_symbol = {
        "window_05_ser":[0.2426, 0.2264, 0.2171, 0.2134, 0.2115, 0.2100, 0.2080, 0.2078, 0.2008, 0.2023, 0.2038] ,
        "window_05_nc": [0.1416, 0.1321, 0.1255, 0.1241, 0.1236, 0.1225, 0.1205, 0.1207, 0.1180, 0.1189, 0.1150],
        "window_05_gc":[0.0809, 0.0755, 0.0724, 0.0711, 0.0705, 0.0700, 0.0693, 0.0693, 0.0670, 0.0674, 0.0650] ,
        "window_166_ser": [0.0385, 0.0397, 0.0400, 0.0379, 0.0370, 0.03665, 0.0366, 0.0356, 0.0355, 0.0331], 
        "window_166_nc": [0.0224, 0.0234, 0.0232, 0.0227, 0.0230, 0.0226, 0.0212, 0.0207, 0.0210, 0.0205, 0.0192] ,
        "window_166_gc": [0.0128, 0.0132, 0.0133, 0.0127, 0.0130, 0.0129, 0.0122, 0.0119, 0.0118, 0.0117, 0.0110] ,
        "trans_2250_ser": [0.2096, 0.1826, 0.1893, 0.1252, 0.0403, 0.0127, 0.0139, 0.0120] ,
        "trans_2250_nc": [0.1225, 0.1068, 0.1107, 0.0724, 0.0232, 0.0072, 0.0081, 0.0067],
        "trans_2250_gc": [0.0699, 0.0609, 0.0631, 0.0418, 0.0134, 0.0045, 0.0046, 0.0040] 
...
plt.semilogy(b["0.5"]["naive"][1,:]/3, symbol_by_symbol["window_166_nc"], "-o", label="Maximum Likelihood - NC")
plt.semilogy(b["0.5"]["naive"][1,:]/3, symbol_by_symbol["window_166_gc"], "-o", label="Maximum Likelihood - GC")
plt.xlabel("Molecule Number per Bit")
plt.ylabel("Bit Error Rate")
plt.legend(loc=3)
plt.grid()
plt.savefig("n_gc_error_window_bit_0555_all.jpg")    
plt.clf()    
...
plt.semilogy(b["0.5"]["naive"][1,:]/3, symbol_by_symbol["window_05_nc"], "-o", label="Maximum Likelihood - NC")
plt.semilogy(b["0.5"]["naive"][1,:]/3, symbol_by_symbol["window_05_gc"], "-o", label="Maximum Likelihood - GC")
plt.xlabel("Molecule Number per Bit")
plt.ylabel("Bit Error Rate")
plt.legend(loc=3)
plt.grid()
plt.savefig("n_gc_error_window_bit_0166_all.jpg")    
plt.clf()       
...
plt.semilogy(tb_naive[:,0]/3, symbol_by_symbol["trans_2250_nc"], "-o", label="Maximum Likelihood - NC")
plt.semilogy(tb_naive[:,0]/3, symbol_by_symbol["trans_2250_gc"], "-o", label="Maximum Likelihood - GC")
plt.xlabel("Transmission time per bit (Sec)")
plt.ylabel("Bit Error Rate")
plt.legend(loc=3)
plt.grid()
plt.savefig("n_gc_error_window_tb_all.jpg")    
plt.clf()
